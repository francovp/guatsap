	...
	public void action()
	{
		...
		if (msg == null) {
			...
			else if (action.equals("stop"))
			{
				...
				((ChatManagerAgent) myAgent).stopCounter();
				// Set reply sentence
			...
			else if (action.equals("continue"))
			{
				...
				((ChatManagerAgent) myAgent).continueCounter();
				// Set reply sentence
			...
			else if (action.equals("move"))
			{
				...
				// Prepare to move
				((ChatManagerAgent)myAgent).nextSite = dest;
				myAgent.doMove(dest);
			}
			...
			else if (action.equals("clone"))
			{
				...
				// Prepare to move
				((ChatManagerAgent)myAgent).nextSite = dest;
				myAgent.doClone(dest, "clone"+((ChatManagerAgent)myAgent).cnt+"of"+myAgent.getName());
			}
